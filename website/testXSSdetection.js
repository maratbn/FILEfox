...
function doLoadFileViaXSS() {
    var text_file = window.nsFILEfox.requestLoadASCIIFile(
                                        [
                                            ...
                                            "FILEfox has a security feature that warns the user when it detects 3-rd party JavaScript -- that is JavaScript coming from some server other than the server serving the main webpage.  ",
                                            "This file loading request is coming from a server address different from the main webpage address, and therefore this dialog box should display such a warning in addition to this message from the demo site.  ",
